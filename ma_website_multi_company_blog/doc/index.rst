...
* Create and configure websites according to the `ma_website_multi_company <https://apps.odoo.com/apps/modules/12.0/ma_website_multi_company_blog/>`__ module documentation
