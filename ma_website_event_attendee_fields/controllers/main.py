...
class WebsiteEventControllerExtended(WebsiteEventController):
    ...
    def registration_confirm(self, event, **post):
        ...
        if res.location:
            ...
            url = request.env['ir.config_parameter'].get_param('ma_website_event_sale.redirection') or res.location
    ...
    @http.route(['/ma_website_event_attendee_fields/check_email'], type='json', auth="public", methods=['POST'], website=True)
