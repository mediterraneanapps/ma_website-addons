...
class TestBackend(common.TestCase):
    ...
    def test_field(self):
        ...
        country_field = self.env.ref('ma_website_event_attendee_fields.attendee_field_country_id')
        # cover name_get()
    ...
    def test_header(self):
        ...
        self.env.ref('ma_website_event_attendee_fields.attendee_field_name').width = '3'
        self.env.ref('ma_website_event_attendee_fields.attendee_field_email').width = '3'
        self.env.ref('ma_website_event_attendee_fields.attendee_field_phone').width = '3'
        self.env.ref('ma_website_event_attendee_fields.attendee_field_country_id').width = '3'
