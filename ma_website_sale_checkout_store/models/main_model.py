...
class WebsiteConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            nobill_noship=config_parameters.get_param("ma_website_sale_checkout_store.nobill_noship", default=False),
            bill_noship=config_parameters.get_param("ma_website_sale_checkout_store.bill_noship", default=False),
            bill_ship=config_parameters.get_param("ma_website_sale_checkout_store.bill_ship", default=False),
            nobill_ship=config_parameters.get_param("ma_website_sale_checkout_store.nobill_ship", default=False),
            bill_ship_option=config_parameters.get_param("ma_website_sale_checkout_store.bill_ship_option", default='nobill_noship'),
        )
        return res
    ...
    def set_values(self):
        ...
        config_parameters = self.env["ir.config_parameter"].sudo()
        for record in self:
            config_parameters.set_param("ma_website_sale_checkout_store.nobill_noship", record.nobill_noship or '')
            config_parameters.set_param("ma_website_sale_checkout_store.bill_noship", record.bill_noship or '')
            config_parameters.set_param("ma_website_sale_checkout_store.bill_ship", record.bill_ship or '')
            config_parameters.set_param("ma_website_sale_checkout_store.nobill_ship", record.nobill_ship or '')
            config_parameters.set_param("ma_website_sale_checkout_store.bill_ship_option", record.bill_ship_option or '')
