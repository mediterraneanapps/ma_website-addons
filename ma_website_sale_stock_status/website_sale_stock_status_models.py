...
class ProductTemplate(models.Model):
    ...
    def update_stock_status_all(self):
        ribbon_backordered = self.env.ref("ma_website_sale_stock_status.ribbon_backordered").id
        ribbon_discontinued = self.env.ref("ma_website_sale_stock_status.ribbon_discontinued").id
        # 3 - unlink, 4 - link
