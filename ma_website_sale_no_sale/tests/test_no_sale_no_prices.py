...
class TestUi(odoo.tests.HttpCase):
    ...
    def test_01_remove_products_prices(self):
        self.enable_environment('ma_website_sale_no_sale.hide_products_prices')
        url = '/shop'
        code = """
    ...
    def test_02_remove_add_to_cart(self):
        self.enable_environment('ma_website_sale_no_sale.hide_add_to_cart')
        self.disable_conflict_module('ma_website_sale_add_to_cart.product')
    ...
    def test_03_remove_product_item_price(self):
        self.enable_environment('ma_website_sale_no_sale.hide_price')
        self.disable_conflict_module('ma_website_sale_add_to_cart.product')
        url = '/shop/product/customizable-desk-9'
        code = """
