...
class PortalEvent(website_account):
    ...
    def portal_my_tickets(self, page=1, date_begin=None, date_end=None, **kw):
        ...
        return request.render("ma_portal_event_tickets.portal_my_tickets", values)
    ...
    def ticket_page(self, ticket=None, **kw):
        ...
        return request.render("ma_portal_event_tickets.portal_ticket_page", values)
    ...
    def ticket_transfer_editor(self, **kw):
        ...
        return request.render("ma_portal_event_tickets.portal_ticket_transfer", values)
